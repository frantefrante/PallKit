...
<section id="spict-home" class="p-4" style="display:none;">
    ...
    <div class="spict-container">
        ...
        <div class="mode-selector">
            <button class="mode-btn active" onclick="switchSpictMode('compile')"><i class="fas fa-edit me-2"></i>Compila</button>
            <button class="mode-btn" onclick="switchSpictMode('visualize')"><i class="fas fa-eye me-2"></i>Visualizza</button>
        </div>
        <div id="spict-compile-section" class="content-section active">
            <div class="spict-card">
                ...
                <div class="general-indicators">
                    <div class="indicator-item" onclick="toggleIndicator(this, 'gen1')"><input type="checkbox" id="gen1"><div class="indicator-text"><label for="gen1">Ricovero(i) ospedaliero(i) non programmato(i)</label></div></div>
                    <div class="indicator-item" onclick="toggleIndicator(this, 'gen2')"><input type="checkbox" id="gen2"><div class="indicator-text"><label for="gen2">Performance Status basso oppure in peggioramento, con limitata reversibilità (es. la persona rimane a letto o in poltrona per più di metà giornata).</label></div></div>
                    <div class="indicator-item" onclick="toggleIndicator(this, 'gen3')"><input type="checkbox" id="gen3"><div class="indicator-text"><label for="gen3">Dipendenza dall'assistenza degli altri a causa di problemi fisici e/o cognitivi in progressivo peggioramento.</label></div></div>
                    <div class="indicator-item" onclick="toggleIndicator(this, 'gen4')"><input type="checkbox" id="gen4"><div class="indicator-text"><label for="gen4">La persona che assiste il paziente necessita di maggiore aiuto e supporto.</label></div></div>
                    <div class="indicator-item" onclick="toggleIndicator(this, 'gen5')"><input type="checkbox" id="gen5"><div class="indicator-text"><label for="gen5">Progressiva perdita di peso; persistente sottopeso; massa muscolare ridotta.</label></div></div>
                    <div class="indicator-item" onclick="toggleIndicator(this, 'gen6')"><input type="checkbox" id="gen6"><div class="indicator-text"><label for="gen6">Sintomi persistenti nonostante il trattamento ottimale della/e patologia/e di base.</label></div></div>
                    <div class="indicator-item" onclick="toggleIndicator(this, 'gen7')"><input type="checkbox" id="gen7"><div class="indicator-text"><label for="gen7">La persona (o la sua famiglia) chiede di ricevere cure palliative; sceglie di ridurre, sospendere o non iniziare nuovi trattamenti; oppure desidera concentrarsi sulla qualità di vita.</label></div></div>
                </div>
                ...
                <div class="pathology-grid">
                    <div class="pathology-card"><div class="pathology-header">Cancro</div><div class="pathology-content"><div class="pathology-item" onclick="toggleIndicator(this, 'canc1')"><input type="checkbox" id="canc1"><div class="pathology-text"><label for="canc1">Deterioramento delle capacità funzionali dovuto alla progressione del cancro.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'canc2')"><input type="checkbox" id="canc2"><div class="pathology-text"><label for="canc2">Le condizioni generali non consentono di iniziare o continuare trattamenti oncologici specifici oppure la terapia in atto è finalizzata unicamente al controllo dei sintomi.</label></div></div></div></div>
                    <div class="pathology-card"><div class="pathology-header">Demenza/Fragilità</div><div class="pathology-content"><div class="pathology-item" onclick="toggleIndicator(this, 'dem1')"><input type="checkbox" id="dem1"><div class="pathology-text"><label for="dem1">Incapacità di vestirsi, camminare o mangiare senza aiuto.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'dem2')"><input type="checkbox" id="dem2"><div class="pathology-text"><label for="dem2">La persona mangia e beve meno; ha difficoltà nella deglutizione.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'dem3')"><input type="checkbox" id="dem3"><div class="pathology-text"><label for="dem3">Incontinenza urinaria e fecale.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'dem4')"><input type="checkbox" id="dem4"><div class="pathology-text"><label for="dem4">Non in grado di comunicare verbalmente; interazione sociale scarsa.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'dem5')"><input type="checkbox" id="dem5"><div class="pathology-text"><label for="dem5">Cadute frequenti; frattura del femore.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'dem6')"><input type="checkbox" id="dem6"><div class="pathology-text"><label for="dem6">Episodi febbrili ricorrenti o infezioni; polmonite da aspirazione.</label></div></div></div></div>
                    <div class="pathology-card"><div class="pathology-header">Patologia cardiaca/vascolare</div><div class="pathology-content"><div class="pathology-item" onclick="toggleIndicator(this, 'card1')"><input type="checkbox" id="card1"><div class="pathology-text"><label for="card1">Scompenso cardiaco o malattia coronarica estesa, non trattabile, con affanno o dolore toracico a riposo o per sforzi lievi.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'card2')"><input type="checkbox" id="card2"><div class="pathology-text"><label for="card2">Malattia vascolare periferica severa ed inoperabile.</label></div></div></div></div>
                    <div class="pathology-card"><div class="pathology-header">Patologia respiratoria</div><div class="pathology-content"><div class="pathology-item" onclick="toggleIndicator(this, 'resp1')"><input type="checkbox" id="resp1"><div class="pathology-text"><label for="resp1">Patologia polmonare cronica severa con affanno a riposo o per sforzi lievi tra gli episodi di riacutizzazione.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'resp2')"><input type="checkbox" id="resp2"><div class="pathology-text"><label for="resp2">Ipossia persistente, con necessità di ossigenoterapia a lungo termine.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'resp3')"><input type="checkbox" id="resp3"><div class="pathology-text"><label for="resp3">Pregressa ventilazione meccanica (invasiva o non) per insufficienza respiratoria, oppure ventilazione controindicata.</label></div></div></div></div>
                    <div class="pathology-card"><div class="pathology-header">Patologia renale</div><div class="pathology-content"><div class="pathology-item" onclick="toggleIndicator(this, 'ren1')"><input type="checkbox" id="ren1"><div class="pathology-text"><label for="ren1">Insufficienza renale cronica stadio 4 o 5 (eGFR <30ml/min) con deterioramento delle condizioni cliniche.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'ren2')"><input type="checkbox" id="ren2"><div class="pathology-text"><label for="ren2">Insufficienza renale che complica altre patologie a prognosi infausta oppure complica la somministrazione di altri trattamenti.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'ren3')"><input type="checkbox" id="ren3"><div class="pathology-text"><label for="ren3">La dialisi viene sospesa oppure non viene iniziata.</label></div></div></div></div>
                    <div class="pathology-card"><div class="pathology-header">Patologia epatica</div><div class="pathology-content"><div class="pathology-item" onclick="toggleIndicator(this, 'ep1')"><input type="checkbox" id="ep1"><div class="pathology-text"><label for="ep1">Cirrosi con una o più delle seguenti complicanze nell'ultimo anno: ascite resistente ai diuretici; encefalopatia epatica; sindrome epatorenale; peritonite batterica; sanguinamento ricorrente da varici.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'ep2')"><input type="checkbox" id="ep2"><div class="pathology-text"><label for="ep2">Il trapianto di fegato non è possibile.</label></div></div></div></div>
                    <div class="pathology-card"><div class="pathology-header">Patologia neurologica</div><div class="pathology-content"><div class="pathology-item" onclick="toggleIndicator(this, 'neur1')"><input type="checkbox" id="neur1"><div class="pathology-text"><label for="neur1">Progressivo deterioramento delle funzioni fisiche e/o cognitive, nonostante la terapia ottimale.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'neur2')"><input type="checkbox" id="neur2"><div class="pathology-text"><label for="neur2">Disturbi della parola con deterioramento progressivo della comunicazione e/o della deglutizione.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'neur3')"><input type="checkbox" id="neur3"><div class="pathology-text"><label for="neur3">Polmonite da aspirazione ricorrente; affanno o insufficienza respiratoria.</label></div></div><div class="pathology-item" onclick="toggleIndicator(this, 'neur4')"><input type="checkbox" id="neur4"><div class="pathology-text"><label for="neur4">Paralisi persistente a seguito di accidente cerebrovascolare, con significativa perdita funzionale e disabilità permanente.</label></div></div></div></div>
                    <div class="pathology-card"><div class="pathology-header">Altre patologie</div><div class="pathology-content"><div class="pathology-item" onclick="toggleIndicator(this, 'alt1')"><input type="checkbox" id="alt1"><div class="pathology-text"><label for="alt1">Peggioramento e rischio di morte a causa di altre patologie o complicanze irreversibili; qualsiasi trattamento avrà scarso beneficio.</label></div></div></div></div>
                </div>
                <div class="action-section">
                    <h3>Rivalutate l'assistenza e le cure in atto. Pianificate il percorso di assistenza e cura.</h3>
                    <div class="action-item" onclick="toggleIndicator(this, 'act1')"><input type="checkbox" id="act1"><div class="indicator-text"><label for="act1">Rivalutate i trattamenti in atto (farmacologici e non) affinché il paziente riceva cure ottimali; minimizzate la polifarmacoterapia.</label></div></div>
                    <div class="action-item" onclick="toggleIndicator(this, 'act2')"><input type="checkbox" id="act2"><div class="indicator-text"><label for="act2">Considerate la possibilità di richiedere una valutazione specialistica se i sintomi o gli altri problemi sono complessi e difficili da gestire.</label></div></div>
                    <div class="action-item" onclick="toggleIndicator(this, 'act3')"><input type="checkbox" id="act3"><div class="indicator-text"><label for="act3">Condividete con il paziente e la sua famiglia il percorso di assistenza e cura, attuale e futuro. Supportate i familiari che assistono il paziente.</label></div></div>
                    <div class="action-item" onclick="toggleIndicator(this, 'act4')"><input type="checkbox" id="act4"><div class="indicator-text"><label for="act4">Pianificate precocemente il percorso di assistenza e cura, se prevedete la perdita della capacità decisionale.</label></div></div>
                    <div class="action-item" onclick="toggleIndicator(this, 'act5')"><input type="checkbox" id="act5"><div class="indicator-text"><label for="act5">Registrate in cartella clinica, comunicate e coordinate il percorso di assistenza e cura.</label></div></div>
                </div>
                <div class="summary">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('#spict-home input[type="checkbox"]').forEach(checkbox => {
                if (!checkbox.disabled) { checkbox.addEventListener('change', updateCounters); }
            });
        });
        function switchSpictMode(mode) {
            document.querySelectorAll('#spict-home .mode-btn').forEach(btn => btn.classList.remove('active'));
            event.target.classList.add('active');
            document.querySelectorAll('#spict-home .content-section').forEach(section => section.classList.remove('active'));
            document.getElementById('spict-' + mode + '-section').classList.add('active');
        }
        function toggleIndicator(element, itemId) {
            const checkbox = element.querySelector('input[type="checkbox"]');
            if (checkbox && !checkbox.disabled) {
                checkbox.checked = !checkbox.checked;
                if (checkbox.checked) { element.classList.add('selected'); } else { element.classList.remove('selected'); }
                updateCounters();
            }
        }
