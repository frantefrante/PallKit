...
function openPerformanceModal(toolId, mode = 'compile') {
  ...
  if (modal) {
    ...
    setTimeout(() => {
      ...
      if(content) content.style.animation = 'modalSlideIn 0.3s ease-out';
    }, 10);
  }
}
...
function switchPerformanceMode(toolId, mode) {
  const modal = document.getElementById('modal-' + toolId);
  if (!modal) return;
  modal.querySelectorAll('.mode-btn').forEach(btn => btn.classList.remove('active'));
  modal.querySelectorAll('.content-section').forEach(section => section.classList.remove('active'));
...
function selectADL(domain, score, element) {
  ...
  const group = document.getElementById(`adl-${domain}-group`);
  if (group) group.querySelectorAll('.radio-option').forEach(o=>o.classList.remove('selected'));
...
function selectBADL(domain, score, element) {
  ...
  const group = document.getElementById(`badl-${domain}-group`);
  if (group) group.querySelectorAll('.radio-option').forEach(o=>o.classList.remove('selected'));
  if (element) element.classList.add('selected');
  calculateBADLScore();
}
...
function resetPerformanceForm(toolId) {
  ...
  if (toolId === 'adl') {
    adlScores = { feeding: null, bathing: null, grooming: null, dressing: null,
      bowel: null, bladder: null, toilet: null, transfer: null,
      mobility: null, stairs: null };
  } else if (toolId === 'badl') {
    badlScores = { hygiene: null, dressing: null, feeding: null,
      transfer: null, mobility: null, continence: null };
  }
...
function generatePerformanceReport(toolId) {
  ...
  if (navigator.msSaveBlob) navigator.msSaveBlob(blob, link.download); else link.click();
...
function printPerformanceTemplate(toolId) {
  ...
  w.document.write(templateContent);
  w.document.close();
  w.focus();
...
<style>
 ...
 .patient-info h3{ color:#6f42c1; margin-top:0; }
 ...
 .scale-items{ margin-bottom:25px; }
 .scale-items h3{ color:#6f42c1; border-bottom:1px solid #6f42c1; padding-bottom:10px; }
 .scale-item{ margin-bottom:12px; padding:12px; border:1px solid #ddd; border-radius:5px; background:#fafafa; }
 .checkbox{ display:inline-block; width:18px; height:18px; border:2px solid #6f42c1; margin-right:12px; vertical-align:middle; }
 .result-section{ margin-top:30px; padding:20px; border:2px solid #6f42c1; border-radius:8px; background:#f8f5fc; }
 .result-section h3{ color:#6f42c1; margin-top:0; }
 .footer{ margin-top:40px; padding-top:20px; border-top:1px solid #ddd; font-size:12px; color:#666; text-align:center; }
 @media print{ body{ margin:10px; } .scale-item{ page-break-inside:avoid; } }
</style>
</head>
<body>
<div class="header">
...
<div class="patient-info">
  <h3>📋 Dati Paziente</h3>
  <div class="form-row">
    <div class="form-field"><strong>Nome e Cognome:</strong><br>___________________________________________</div>
    <div class="form-field"><strong>Data di nascita:</strong><br>_________________________</div>
  </div>
  <div class="form-row">
    <div class="form-field"><strong>Codice Fiscale:</strong><br>___________________________________________</div>
    <div class="form-field"><strong>Data valutazione:</strong><br>_________________________</div>
  </div>
  <div class="form-row">
    <div class="form-field"><strong>Medico valutatore:</strong><br>___________________________________________</div>
    <div class="form-field"><strong>Contesto:</strong><br>_________________________</div>
  </div>
</div>
...
<div class="result-section">
  ...
  <div class="form-row">
    <div class="form-field"><strong>Punteggio totale:</strong><br>___________________________</div>
    <div class="form-field"><strong>Interpretazione:</strong><br>___________________________</div>
  </div>
  <div style="margin-top:20px;"><strong>Note cliniche:</strong><br>________________________________________________________________________<br>________________________________________________________________________<br>________________________________________________________________________<br></div>
  <div style="margin-top:20px;"><strong>Raccomandazioni:</strong><br>________________________________________________________________________<br>________________________________________________________________________<br>________________________________________________________________________<br></div>
  <div style="margin-top:20px;"><strong>Prossima rivalutazione:</strong> _____________________ <strong>Firma medico:</strong> _____________________</div>
</div>
<div class="footer">
...
function getTemplateItems(toolId) {
  ...
  if (toolId === 'adl') {
    return `
        <div class="scale-item"><strong>1. Alimentazione</strong><br>
        <span class="checkbox"></span> 0 - Necessita assistenza &nbsp;&nbsp;
        <span class="checkbox"></span> 1 - Assistenza per tagliare &nbsp;&nbsp;
        <span class="checkbox"></span> 2 - Indipendente</div>
        <div class="scale-item"><strong>2. Bagno</strong><br>
        <span class="checkbox"></span> 0 - Dipendente &nbsp;&nbsp;
        <span class="checkbox"></span> 1 - Indipendente</div>
        <div class="scale-item"><strong>3. Cura personale</strong><br>
        <span class="checkbox"></span> 0 - Necessita assistenza &nbsp;&nbsp;
        <span class="checkbox"></span> 1 - Indipendente</div>
        <div class="scale-item"><strong>4. Vestirsi</strong><br>
        <span class="checkbox"></span> 0 - Dipendente &nbsp;&nbsp;
        <span class="checkbox"></span> 1 - Assistenza &nbsp;&nbsp;
        <span class="checkbox"></span> 2 - Indipendente</div>
        <div class="scale-item"><strong>5. Controllo intestinale</strong><br>
        <span class="checkbox"></span> 0 - Incontinente &nbsp;&nbsp;
        <span class="checkbox"></span> 1 - Incidenti occasionali &nbsp;&nbsp;
        <span class="checkbox"></span> 2 - Continente</div>
        <div class="scale-item"><strong>6. Controllo vescicale</strong><br>
        <span class="checkbox"></span> 0 - Incontinente &nbsp;&nbsp;
        <span class="checkbox"></span> 1 - Incidenti occasionali &nbsp;&nbsp;
        <span class="checkbox"></span> 2 - Continente</div>
        <div class="scale-item"><strong>7. Uso WC</strong><br>
        <span class="checkbox"></span> 0 - Dipendente &nbsp;&nbsp;
        <span class="checkbox"></span> 1 - Assistenza &nbsp;&nbsp;
        <span class="checkbox"></span> 2 - Indipendente</div>
        <div class="scale-item"><strong>8. Trasferimento letto-sedia</strong><br>
        ...
        <span class="checkbox"></span> 3 - Indipendente</div>
        <div class="scale-item"><strong>9. Mobilità su superfici piane</strong><br>
        ...
        <span class="checkbox"></span> 3 - Indipendente</div>
        <div class="scale-item"><strong>10. Scale</strong><br>
        <span class="checkbox"></span> 0 - Incapace &nbsp;&nbsp;
        <span class="checkbox"></span> 1 - Assistenza &nbsp;&nbsp;
        <span class="checkbox"></span> 2 - Indipendente</div>
    `;
  ...
  if (toolId === 'badl') {
    return `
        ...
        <div class="scale-item"><strong>1. Igiene personale</strong><br>
        <span class="checkbox"></span> 0 &nbsp;&nbsp;<span class="checkbox"></span> 1 &nbsp;&nbsp;<span class="checkbox"></span> 2 &nbsp;&nbsp;<span class="checkbox"></span> 3</div>
        <div class="scale-item"><strong>2. Vestirsi</strong><br>
        <span class="checkbox"></span> 0 &nbsp;&nbsp;<span class="checkbox"></span> 1 &nbsp;&nbsp;<span class="checkbox"></span> 2 &nbsp;&nbsp;<span class="checkbox"></span> 3</div>
        <div class="scale-item"><strong>3. Alimentarsi</strong><br>
        <span class="checkbox"></span> 0 &nbsp;&nbsp;<span class="checkbox"></span> 1 &nbsp;&nbsp;<span class="checkbox"></span> 2 &nbsp;&nbsp;<span class="checkbox"></span> 3</div>
        <div class="scale-item"><strong>4. Trasferimenti</strong><br>
        <span class="checkbox"></span> 0 &nbsp;&nbsp;<span class="checkbox"></span> 1 &nbsp;&nbsp;<span class="checkbox"></span> 2 &nbsp;&nbsp;<span class="checkbox"></span> 3</div>
        <div class="scale-item"><strong>5. Mobilità nel letto</strong><br>
        <span class="checkbox"></span> 0 &nbsp;&nbsp;<span class="checkbox"></span> 1 &nbsp;&nbsp;<span class="checkbox"></span> 2 &nbsp;&nbsp;<span class="checkbox"></span> 3</div>
        <div class="scale-item"><strong>6. Controllo sfinterico</strong><br>
        <span class="checkbox"></span> 0 &nbsp;&nbsp;<span class="checkbox"></span> 1 &nbsp;&nbsp;<span class="checkbox"></span> 2 &nbsp;&nbsp;<span class="checkbox"></span> 3</div>
    `;
  }
  return '';
...
function saveToLocalStorage(toolId, data) {
  try {
    localStorage.setItem(`perf_${toolId}_${Date.now()}`, JSON.stringify(data));
  } catch (e) {
