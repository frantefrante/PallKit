...
<div class="valutazione-detail-section">
  ...
  if (categoryName === 'performance') {
    ...
    <div class="valutazione-detail-section">
      <div class="page-header">
        <div class="page-icon mb-3">🏃‍♂️</div>
        <h1 class="page-title">Scale di Performance</h1>
        <p class="page-subtitle">Strumenti per valutare il livello funzionale del paziente</p>
      </div>

      <div class="tools-grid performance-grid">
        <div class="tool-card tool-card-compact h-100 performance-card akps-performance">
          <div class="tool-header">
        ...
        <div class="tool-card tool-card-compact h-100 performance-card pps-performance">
          <div class="tool-header">
            <div class="tool-icon-large performance-icon">
        ...
        <div class="tool-card tool-card-compact h-100 performance-card adl-performance">
          <div class="tool-header">
            <div class="tool-icon-large performance-icon">
        ...
        <div class="tool-card tool-card-compact h-100 performance-card badl-performance">
          <div class="tool-header">
            <div class="tool-icon-large performance-icon">
